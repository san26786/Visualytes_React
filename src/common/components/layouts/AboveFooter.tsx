...
//               <div
//                 key={item.title}
//                 className=" teaser-card text-center"
//               >
//                 {/* Icon Circle */}
//                 {/* <div
//                   className="
...
//     content: (
//       <>
//         <p>Cumberland House, Southampton, SO15 2BG</p>
...
//       {/* Top vertical line */}
//       <div className="flex justify-center">
//         <img src="/assets/png/vertical_line3.png" alt="" />
//       </div>
...
//             <div key={item.title} className="teaser-card text-center">
//               {/* Icon Circle */}
//               <div className="mx-auto flex h-[163px] w-[163px] items-center justify-center rounded-full border-[4px] border-white bg-transparent p-[4px]">
